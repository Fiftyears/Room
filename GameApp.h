...
public:
	...
	enum class ShowMode { WoodCrate, FireAnim,TextureBox };
...
private:
	...
	//ComPtr<ID3D11InputLayout> m_pVertexLayout;                  // 火焰盒子
	...
	std::vector<ComPtr<ID3D11ShaderResourceView>> m_pWoodCrate;     //木盒纹理集
	std::vector<ComPtr<ID3D11ShaderResourceView>> m_pFlare;         //混合纹理集
